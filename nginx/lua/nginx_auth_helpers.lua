...
--  (see commented-out examples for usage)
local path_role_envs = {
--    { pattern = "^/foobar/(api/)?sessions?/.+/payload(?:$|[/?])", roles = {
--        "ROLE_ADMIN",
--        "ROLE_READ_ACCESS",
--        "ROLE_READ_WRITE_ACCESS"
--    }},
--    { pattern = "^/foobar/(api/)?sessions?[./]data", roles = {
--        "ROLE_ADMIN",
--        "ROLE_READ_ACCESS",
--        "ROLE_READ_WRITE_ACCESS"
--    }},
--    { pattern = "^/foobar/(api/)?sessions?/(add|remove)tags", roles = {
--        "ROLE_ADMIN",
--        "ROLE_READ_WRITE_ACCESS"
--    }},
--    { pattern = "^/foobar/(api/)?(cron|delete|upload)", roles = {
--        "ROLE_ADMIN",
--        "ROLE_READ_WRITE_ACCESS"
--    }},
--    { pattern = "^/foobar/(api/)?admin", roles = {
--        "ROLE_ADMIN"
--    }}
}

-- Define URI pattern → role mappings (i.e., helps us turn "read_access" into "foobar_read_access")
--   For some other services you may be able to just define all the roles in that service,
--   but this is a convenient way to avoid duplication.
--  (see commented-out examples for usage)
local uri_role_mappings = {
--    ["^/(foobar|quux)"] = {
--        { from = "ROLE_ADMIN", to = { "ROLE_FOOBAR_ADMIN",
--                                      "ROLE_FOOBAR_READ_WRITE_ACCESS",
--                                      "ROLE_FOOBAR_DATA_ACCESS",
--                                      "ROLE_FOOBAR_SEARCH_ACCESS",
--                                      "ROLE_FOOBAR_QUUX_READ_ACCESS",
--                                      "ROLE_FOOBAR_QUUX_READ_WRITE_ACCESS" } },
--        { from = "ROLE_READ_ACCESS", to = { "ROLE_FOOBAR_READ_ACCESS",
--                                            "ROLE_FOOBAR_DATA_ACCESS",
--                                            "ROLE_FOOBAR_QUUX_READ_ACCESS" } },
--        { from = "ROLE_READ_WRITE_ACCESS", to = { "ROLE_FOOBAR_READ_WRITE_ACCESS",
--                                                  "ROLE_FOOBAR_PCAP_ACCESS",
--                                                  "ROLE_FOOBAR_SEARCH_ACCESS",
--                                                  "ROLE_FOOBAR_QUUX_READ_ACCESS",
--                                                  "ROLE_FOOBAR_QUUX_READ_WRITE_ACCESS" } }
--    },
--    ["^/(dashboards/app/)?(hh-)?download-files"] = {
--        { from = "ROLE_ADMIN", to = "ROLE_DOWNLOAD_FILES" },
--        { from = "ROLE_READ_ACCESS", to = "ROLE_DOWNLOAD_FILES" },
--        { from = "ROLE_READ_WRITE_ACCESS", to = "ROLE_DOWNLOAD_FILES" }
--    },
--    ["^/barbaz"] = {
--        { from = "ROLE_READ_ACCESS", to = "ROLE_BARBAZ_READ_ACCESS" },
--        { from = "ROLE_READ_WRITE_ACCESS", to = "ROLE_BARBAZ_READ_WRITE_ACCESS" }
--    }
}
